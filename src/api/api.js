...
// 获取所有学生
export let getAll = () => {
  return Axios.get("http://132.232.89.22:8998/allstudent");
};
// 所有学生分页操作
...
export let inExcel = excarr => {
  return Axios.post("http://132.232.89.22:8998/inExcel", {
    excarr
  });
};
// 向所有学生表中添加一项
...
export let getHeadTeacher = () => {
  return Axios.get("http://132.232.89.22:8998/getHeadTeacher");
};
// 添加一条班主任
export let addHeadTeacher = list => {
  return Axios.post("http://132.232.89.22:8998/addHeadTeacher", {
    ...list
  });
};
// 删除一条班主任
export let delHeadTeacher = id => {
  return Axios.post("http://132.232.89.22:8998/delHeadTeacher", { _id: id });
};
// 获取所有市场部
export let getMarket = () => {
  return Axios.get("http://132.232.89.22:8998/getMarket");
};
// 获取所有班级
export let getClass = () => {
  return Axios.get("http://132.232.89.22:8998/getClass");
};
// 销毁一个班级
export let delClass = id => {
  return Axios.post("http://132.232.89.22:8998/delClass", { _id: id });
};
// 创建班级
export let createClass = data => {
  return Axios.post("http://132.232.89.22:8998/createClass", data);
};
// 修改班级
export let updateClass = data => {
  return Axios.post("http://132.232.89.22:8998/updateClass", data);
};
